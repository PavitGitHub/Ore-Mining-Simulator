...
public class OreSimOriginalTest {
    ...
    public void testOreEnd() {
        ...
        assertEquals("16-7", oreTestData.actorLocations.get(ElementType.PUSHER).stream().findFirst().get());
        ...
        assertEquals(clayLocations, oreTestData.actorLocations.get(ElementType.CLAY));
    }
    ...
    public void testOreBeforePush() {
        ...
        assertEquals(1, oreTestData.actorLocations.get(ElementType.TARGET).size());
        assertEquals(1, oreTestData.actorLocations.get(ElementType.PUSHER).size());
        assertEquals("17-6", oreTestData.actorLocations.get(ElementType.PUSHER).stream().findFirst().get());
        assertEquals("17-8", oreTestData.actorLocations.get(ElementType.TARGET).stream().findFirst().get());
        assertEquals(5, oreTestData.actorLocations.get(ElementType.CLAY).size());
        Set<String> clayLocations = new HashSet<>(Arrays.asList("7-5", "7-6", "6-8", "7-8", "8-8"));
        assertEquals(clayLocations, oreTestData.actorLocations.get(ElementType.CLAY));
    }
    ...
    public void testOreAfterPush() {
        ...
        assertEquals(1, oreTestData.actorLocations.get(ElementType.TARGET).size());
        assertEquals(1, oreTestData.actorLocations.get(ElementType.PUSHER).size());
        assertEquals("17-7", oreTestData.actorLocations.get(ElementType.PUSHER).stream().findFirst().get());
        assertEquals("17-7", oreTestData.actorLocations.get(ElementType.TARGET).stream().findFirst().get());
        assertEquals(5, oreTestData.actorLocations.get(ElementType.CLAY).size());
        Set<String> clayLocations = new HashSet<>(Arrays.asList("7-5", "7-6", "6-8", "7-8", "8-8"));
        assertEquals(clayLocations, oreTestData.actorLocations.get(ElementType.CLAY));
    }
